...
import userGroupRoutes from './modules/auth/routes/user-group.routes';
...
app.use('/api/products', cacheMiddleware(10 * 60 * 1000), optimizeImages, productRoutes); // Cache for 10 minutes
app.use('/api/pages', cacheMiddleware(30 * 60 * 1000), pageRoutes); // Cache for 30 minutes
app.use('/api/leads', leadRoutes);
app.use('/api/auth', authRoutes);
app.use('/api/user-groups', userGroupRoutes);
app.use('/api/users', usersRoutes);
// app.use('/api/companies', companyRoutes); // Temporarily disabled
