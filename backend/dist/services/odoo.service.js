...
const odooApi = axios_1.default.create({
    baseURL: ODOO_URL,
    timeout: 30000,
    headers: {
...
class OdooService {
    static adminUid = null;
    static async userAuthenticate(login, password) {
    ...
    static async createUser(login, password, name) {
    ...
    static async sendPreRegistrationEmail(email, token) {
    ...
    static async authenticate() {
        ...
        this.adminUid = result;
        return this.adminUid;
    }
    static async executeKw(model, method, args, kwargs = {}) {
